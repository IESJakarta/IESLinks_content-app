...
<script setup>
const url = `https://raw.githubusercontent.com/IESJakarta/IESLinks_content-app/refs/heads/dev-localjson/public/data/IPdata.json`
var { data: count } = await $fetch(url)
</script>

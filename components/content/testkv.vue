...
<template>
  ...
  <div class=topgrid style="text-align: left">
    ...
    <span style="text-align: center">
      ...
      <h3 style="margin-bottom: 0;">Weekend of {{ data.data.IPdata.["Weekend Date"] }}</h3>
    </span>
    <p></p>
    <p></p>
    <ul>
      <li v-for="(x, key) in data.data.IPdata.servicedata" style="line-height: 2em; margin-left: 1.3em; margin-bottom: 1.5em;">{{ key }}
